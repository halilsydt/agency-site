...
export const metadata: Metadata = {
  title: "E-commerce Consulting for Etsy & Amazon Sellers | Scalenty",
  description:
    "Honest, results-driven consulting to help Etsy and Amazon sellers grow their businesses. Transparent pricing, real expertise, practical strategies.",
  openGraph: {
    title: "E-commerce Consulting for Etsy & Amazon Sellers | Scalenty",
    description:
